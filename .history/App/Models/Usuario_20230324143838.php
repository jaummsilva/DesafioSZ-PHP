...
class Usuario extends Model {
    ...
    public function deletarUsuario() {
        $query = "delete from playlist_has_musica where id_musica = :id_musica and id_playlist = :id_playlist";
        $smtm = $this->db->prepare($query);
        $smtm->bindValue(':id_musica', $this->__get('id_musica'));
        $smtm->bindValue(':id_playlist', $this->__get('id'));
        $smtm->execute();
        return $smtm->fetchAll(\PDO::FETCH_ASSOC);
    }
